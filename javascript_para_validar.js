                        ...
                        unidadesUnicas.forEach((unidad, index) => {
                            setTimeout(() => {
                                ...
                                if (unidadDiv) {
                                    ...
                                    const anio = unidadDiv.querySelector('[name^="vehiculo_a̱o_"]');
                                    ...
                                    if (anio) anio.value = unidad.anio || unidad.a̱o || '';
                ...
                case 2:
                    ...
                    document.querySelectorAll('.unidad-vehiculo-item').forEach((item, index) => {
                        const vehiculo = {
                            ...
                            a̱o: item.querySelector('[name^="vehiculo_a̱o_"]').value,
                            soluciones: [],
        ...
        function cargarProgreso() {
            ...
            if (contUnidades && Array.isArray(cotizacionData.vehiculos) && cotizacionData.vehiculos.length > 0) {
                ...
                cotizacionData.vehiculos.forEach((vehiculo, idx) => {
                    ...
                    setByNameLike('vehiculo_a̱o_', vehiculo.a̱o || vehiculo.anio || '');
        ...
        function agregarUnidadVehiculo() {
            ...
            unidadDiv.innerHTML = `
                ...
                <div class="row">
                    ...
                    <div class="col-md-1">
                        <label class="form-label fw-bold" for="vehiculo_a̱o_${unidadVehiculoCounter}">A̱o</label>
                        <input type="number" class="form-control" id="vehiculo_a̱o_${unidadVehiculoCounter}" name="vehiculo_a̱o_${unidadVehiculoCounter}" min="1990" max="2025" placeholder="A̱o">
                    </div>
                </div>
                        ...
                        <div class="alert alert-success">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <p class="mb-1"><strong>Modelo:</strong> ${unidadModelo.marca || 'Sin marca'} ${unidadModelo.tipo_unidad || unidadModelo.tipo || 'Sin tipo'} ${unidadModelo.modelo || ''} ${unidadModelo.anio || unidadModelo.a̱o || ''}</p>
                    ...
                    vehiculosDiv.innerHTML = `
                        ...
                        ${vehiculos.map((vehiculo, index) => `
                            <div class="mb-3 border rounded p-2">
                                <strong>Unidad ${index + 1}:</strong> ${vehiculo.marca || 'Sin marca'} ${vehiculo.tipo_unidad || vehiculo.tipo || 'Sin tipo'} ${vehiculo.modelo || ''} ${vehiculo.anio || vehiculo.a̱o || ''} - ${vehiculo.combustible || 'Sin combustible'} ${vehiculo.voltaje || ''}
